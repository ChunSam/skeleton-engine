...
**Shipped so far: 32 of the 39, in six batches** — v0.156.27 (the four panics + two blank-render
...
version bump), and v0.156.31 (four read-derived behaviour rows). **What is left is 7 rows: 1
read-derived behaviour, 4 measured allocation, and 2 that need the maintainer** — no reproduced
defect and no doc drift remains in this section.
