...
**Shipped so far: 28 of the 39, in five batches** — v0.156.27 (the four panics + two blank-render
...
whose geometry contradicted their own docs), and the four doc-drift rows on 2026-09-08 (prose, no
version bump). **What is left is 11 rows: 5 read-derived behaviour, 4 measured allocation, and 2
that need the maintainer** — no reproduced defect and no doc drift remains in this section.
