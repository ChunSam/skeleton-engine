...
**47 of the 50 rows are settled and 3 are open** — 40 shipped as releases v0.156.6–v0.156.26 on
...
timeline keyframe drag, shipped as **v0.159.1** on 2026-09-10 — see the re-derivation note below.
...
⚠️ **And on 2026-09-10 one of those four fell to the same re-derivation, which makes it the
fourth time and the second where the gate alone kept a row deferred — so the 2026-09-03
re-derivation above is itself an example of the thing it warns about.** "A windowed run, or a
