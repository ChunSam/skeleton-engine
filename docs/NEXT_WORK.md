...
**Shipped so far: 24 of the 39, in four batches** — v0.156.27 (the four panics + two blank-render
...
whose geometry contradicted their own docs). **What is left is 15 rows: 5 read-derived behaviour,
4 measured allocation, 4 doc drift, and 2 that need the maintainer** — no reproduced defect
